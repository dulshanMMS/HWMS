...
export const buildWorkflowPreferences = (inputPreferences, defaultPreferences = DEFAULT_WORKFLOW_PREFERENCES) => {
    ...
    return {
        ...
        channels: {
            ...
            ...Object.values(ChannelTypeEnum).reduce((output, channel) => ({
                ...output,
                [channel]: {
