import { ActorTypeEnum, ButtonTypeEnum, ChannelCTATypeEnum, IEmailBlock, ITemplateVariable, MessageActionStatusEnum, MessageTemplateContentType, StepTypeEnum, UrlTarget } from '../../types';
