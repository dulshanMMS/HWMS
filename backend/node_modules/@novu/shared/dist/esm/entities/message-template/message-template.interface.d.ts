import { ChannelCTATypeEnum, EnvironmentId, IEmailBlock, ITemplateVariable, MessageTemplateContentType, OrganizationId, StepTypeEnum, TemplateVariableTypeEnum } from '../../types';
