import { CreateWorkflowDto, GeneratePreviewRequestDto, GeneratePreviewResponseDto, GetListQueryParams, ListWorkflowResponse, PatchStepDataDto, PatchWorkflowDto, StepResponseDto, SyncWorkflowDto, UpdateWorkflowDto, WorkflowResponseDto, WorkflowTestDataResponseDto } from '../dto';
...
export declare const createWorkflowClient: (baseUrl: string, headers?: HeadersInit) => {
    ...
    getWorkflowStepData: (workflowId: string, stepId: string) => Promise<NovuRestResult<StepResponseDto, HttpError>>;
    patchWorkflowStepData: (workflowId: string, stepId: string, patchStepDataDto: PatchStepDataDto) => Promise<NovuRestResult<StepResponseDto, HttpError>>;
