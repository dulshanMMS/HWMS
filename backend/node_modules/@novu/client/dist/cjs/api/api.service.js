...
class ApiService {
    ...
    markMessagesAs(_a) {
        return __awaiter(this, arguments, void 0, function* ({ messageId, markAs, }) {
    ...
    getNotificationsList(page_1) {
        return __awaiter(this, arguments, void 0, function* (page, _a = {}) {
            ...
            const newVar = yield this.httpClient.getFullResponse(`/widgets/notifications/feed`, Object.assign(Object.assign({ page }, (payloadString && { payload: payloadString })), rest));
            return newVar;
        });
    }
    initializeSession(appId_1, subscriberId_1) {
        return __awaiter(this, arguments, void 0, function* (appId, subscriberId, hmacHash = null) {
    ...
    getPreferences(_a) {
        return __awaiter(this, arguments, void 0, function* ({ level, }) {
