// models/seatBooking.js - Minimal model like ParkingSlots.js
...
MemberBookingSchema.index({ memberName: 1, teamId: 1 }, { unique: true });
MemberBookingSchema.index({ memberName: 1, status: 1 });
...
const MemberBooking = mongoose.model("seatingslots", MemberBookingSchema);
